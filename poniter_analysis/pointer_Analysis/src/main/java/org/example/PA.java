...
/*
    ...
    5.  class soot.jimple.internal.JIdentityStmt	: 	r1 := @parameter0: java.lang.String[]
        class soot.jimple.internal.JAssignStmt	    : 	$r0 = new org.example.test
        class soot.jimple.internal.JInvokeStmt	    : 	specialinvoke $r0.<org.example.test: void <init>()>()
        class soot.jimple.internal.JInvokeStmt	    : 	virtualinvoke $r0.<org.example.test: void foo()>()
        class soot.jimple.internal.JAssignStmt	    : 	$r0.<org.example.test: int aa> = 30
        class soot.jimple.internal.JAssignStmt	    : 	$r0.<org.example.test: int bb> = 30
        ...
        class soot.jimple.internal.JAssignStmt	    : 	$r0.<org.example.test: int bb> = 30
        class soot.jimple.internal.JReturnVoidStmt	: 	return
        class soot.jimple.internal.JIdentityStmt	: 	r0 := @this: org.example.test
        class soot.jimple.internal.JInvokeStmt	    : 	specialinvoke r0.<java.lang.Object: void <init>()>()
        class soot.jimple.internal.JAssignStmt	    : 	r0.<org.example.test: int aa> = 10
        class soot.jimple.internal.JAssignStmt	    : 	r0.<org.example.test: int bb> = 20
        class soot.jimple.internal.JReturnVoidStmt	: 	return
 */
public class PA {
